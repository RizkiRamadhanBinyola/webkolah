    ...
    if (isset($_POST['simpan'])) {
        ...
        if (!isset($error)) {
            if ($mode == "Tambah") {
                ...
                $insert_query = "INSERT INTO agama (id_agama, nama_agama, tgl_input, user_input, id_user) VALUES (?, ?, ?, ?, ?)";
                ...
                $update_query = "UPDATE agama SET nama_agama = ? WHERE id_agama = ?";
                $update_stmt = $conn->prepare($update_query);
                $update_stmt->bind_param('ss', $nama_agama, $id_agama);
